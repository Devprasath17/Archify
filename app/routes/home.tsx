      ...
      <div className = "home">
        <Navbar/>
          <section className="hero">
              ...
              <h1> Builld beautiful spaces at the speed of thought with Archify</h1>
              <p className="subtitle">
                  Archify is an AI-first design environment that help you visualize, render, and ship architectural projects faster that ever.
              </p>
